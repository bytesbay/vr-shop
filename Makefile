...
VRS-Linux-Debug:
	 $(PROJECTBUILD) VRS Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRS-Linux-DebugGame:
	 $(PROJECTBUILD) VRS Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRS-Linux-Shipping:
	 $(PROJECTBUILD) VRS Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRS-Linux-Test:
	 $(PROJECTBUILD) VRS Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRS:
	 $(PROJECTBUILD) VRS Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSEditor-Linux-Debug:
	 $(PROJECTBUILD) VRSEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSEditor-Linux-DebugGame:
	 $(PROJECTBUILD) VRSEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSEditor-Linux-Shipping:
	 $(PROJECTBUILD) VRSEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSEditor-Linux-Test:
	 $(PROJECTBUILD) VRSEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSEditor:
	 $(PROJECTBUILD) VRSEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
