...
unrealRootPath=/home/bytesbay/Downloads/UnrealEngine-release
VRSRootPath=/home/bytesbay/Documents/Unreal Projects/VRS

gameProjectFile=/home/bytesbay/Documents/Unreal Projects/VRS/VRS.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(VRSSource.pri)
include(VRSHeader.pri)
include(VRSConfig.pri)
include(VRSIncludes.pri)
include(VRSDefines.pri)
...
VRS-Linux-Debug.commands = $$build VRS Linux Debug  -project="\"$$gameProjectFile\"" $$args
VRS-Linux-DebugGame.commands = $$build VRS Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
VRS-Linux-Shipping.commands = $$build VRS Linux Shipping  -project="\"$$gameProjectFile\"" $$args
VRS-Linux-Test.commands = $$build VRS Linux Test  -project="\"$$gameProjectFile\"" $$args
VRS.commands = $$build VRS Linux Development  -project="\"$$gameProjectFile\"" $$args

VRSEditor-Linux-Debug.commands = $$build VRSEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
VRSEditor-Linux-DebugGame.commands = $$build VRSEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
VRSEditor-Linux-Shipping.commands = $$build VRSEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
VRSEditor-Linux-Test.commands = $$build VRSEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
VRSEditor.commands = $$build VRSEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	VRS-Linux-Test \
	VRS \
	VRSEditor-Linux-Debug \
	VRSEditor-Linux-DebugGame \
	VRSEditor-Linux-Shipping \
	VRSEditor-Linux-Test \
	VRSEditor \
